...
export const metadata = {
  title: "Terms and Conditions — Nimbus studio",
  description:
              ...
              <div className="container position-relative">
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      ...
                      Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                      &quot;Our&quot; in this Agreement) refers to Nimbus
                      studio, 123 Main St, Hamburg, Germany.
                    </p>
                  </li>
                  <li>
                    <p>
                  ...
                  <li>
                    <p>
                      <strong>Website</strong> refers to Nimbus studio,
                      accessible from{" "}
                      <a
                        href="https://nimbus-studios.pages.dev"
                        rel="external nofollow noopener"
                        target="_blank"
                      >
                        https://nimbus-studios.pages.dev
                      </a>
                    </p>
                  </li>
                  <li>
                ...
                <ul>
                  <li>
                    By email:{" "}
                    <a
                      href="mailto:hello@nimbus-studios.pages.dev"
                      className="text-primary"
                    >
                      hello@nimbus-studios.pages.dev
                    </a>
                  </li>
                </ul>
              </div>
